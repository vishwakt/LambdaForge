...
| S3: Trades DB | `stock-trader-db-experimental-YOUR_AWS_ACCOUNT_ID` |
...
- S3: read/write for `stock-trader-db-YOUR_AWS_ACCOUNT_ID` and `stock-trader-db-live-YOUR_AWS_ACCOUNT_ID`
...
aws s3 rm s3://stock-trader-db-live-YOUR_AWS_ACCOUNT_ID/trades.db
