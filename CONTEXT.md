...
1. **S3TradesDbBucket** — add the new bucket ARN: `arn:aws:s3:::stock-trader-db-<suffix>-042697403670`
2. **SSMParameterStoreManagement** — add the new prefix: `arn:aws:ssm:us-east-1:042697403670:parameter/stock-bot-<suffix>/*`
